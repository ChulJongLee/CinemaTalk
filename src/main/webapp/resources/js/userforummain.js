...
$(".contentnodistinct").each( function likeNhateresult() {
		...
		$.ajax({
	        ...
	        , success: function (res) {
	        	if(res.likecheck==1){
		    		$(y).siblings('#forum_like').find('.forum_likebtn').prepend('<div class="thumbup"><i class="fas fa-thumbs-up" id="forum_likebtn2">&nbsp</i></div>');
	        	}else{
	        		$(y).siblings('#forum_like').find('.forum_likebtn').prepend('<div class="thumbup"><i class="far fa-thumbs-up" id="forum_likebtn2">&nbsp</i></div>');	        		
	        	}
	        	$(y).siblings('#forum_like').find('.likeresult').html(res.like);
	        	},
		});
		...
		$.ajax({
	        ...
	        , success: function (res) {
	        	if(res.hatecheck==1){
		    		$(y).siblings('#forum_dislike').find('.forum_dislikebtn').prepend('<div class="thumbdown"><i class="fas fa-thumbs-down" id="forum_dislikebtn2">&nbsp</i></div>');
	        	}else{
	        		$(y).siblings('#forum_dislike').find('.forum_dislikebtn').prepend('<div class="thumbdown"><i class="far fa-thumbs-down" id="forum_dislikebtn2">&nbsp</i></div>');	        		
	        	}
	        	$(y).siblings('#forum_dislike').find('.dislikeresult').html(res.dislike);	
	        },
		});
