...
<body>
    ...
    <section id="bestsection">
        ...
        <div class="bestreview">
         	<c:if test="${fn:length(bestreviewlist) == 0}">
               <h5>자료가 없습니다.</h5>
            </c:if>
         		...
         		<c:forEach var="list" items="${bestreviewlist }">        			
					<li id="contents">
						...
						<div class="content3" style="display:none"></div>
							...
							<c:if test="${sessionScope.user.user_id==null}">
								<div id="report">
									<button class="reportbtn reportbtnnull" value="${list.contentno }" title="로그인이 필요한 서비스입니다.">
										<i class="fas fa-flag" id="reportbtn2"></i>
										신고
									</button>
								</div>
         	...
         	<ul id="contentslist">
         		<c:forEach var="list" items="${generalreviewlist }">
					<li id="contents">				
						...
						<c:if test="${sessionScope.user.user_id==null}">
							<div id="report">
								<button class="reportbtn" value="${list.contentno }" title="로그인이 필요한 서비스입니다.">
									<i class="fas fa-flag" id="reportbtn2"></i>
									신고
								</button>
							</div>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">	         
		    	...
		    	<textarea id="modaltext" name="contents"></textarea>			    	
		      </div>
