...
<section>
	<form action="userforuminsertresult" method="post" enctype="multipart/form-data"  onsubmit="return writeSubmit();">
		...
		<div id="title">
			...
			<input type="text" class="title" name="content_title" placeholder="제목을 입력하세요.(최대 30자)" required="required" maxlength="30">
		</div>
		<div id="content">
			<label for="content_content">내용</label>
			<textarea class="content" name="content_content" placeholder="내용을 입력하세요."></textarea>		
		</div>
		<div id="photo">
