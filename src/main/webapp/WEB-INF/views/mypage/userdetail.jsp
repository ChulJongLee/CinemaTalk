			...
			<form>
				<ul>
					...
					<li>
						...
						<input type="password" name="user_pwd" maxLength="20" value="${user.user_pwd}" readonly>
					</li>
					<li>
						<label for="user_nickname">닉네임</label>
						<input type="text" name="user_nickname" value="${user.user_nickname}" readonly>
					</li>
					<li>
					...
					<li>
						...
						<input type="text" name="user_bdate" value="${user.user_bdate}" readonly>
					</li>
					<li>
						<input type="hidden" name="user_no" value="${user.user_no}">
						<button type="button" id="usermodify">회원 정보 수정</button>
						<button type="button" id="userdel">회원 탈퇴</button>
					</li>
				</ul>
			</form>
		</div>
